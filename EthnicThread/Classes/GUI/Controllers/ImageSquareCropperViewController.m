...
@interface ImageSquareCropperViewController ()
...
@implementation ImageSquareCropperViewController
...
- (void)initView {
    ...
    //    self.ratioView.layer.borderColor = MAIN_COLOR.CGColor;
    //    self.ratioView.layer.borderWidth = 1.0f;
    self.ratioView.autoresizingMask = UIViewAutoresizingNone;
//    [self.ratioView setImage:[UIImage imageNamed:@"round_crop"]];
...
- (void)initControlBtn {
    ...
    UIView *botomView = [[UIView alloc] initWithFrame:rect];
    [botomView setBackgroundColor:[UIColor blackColor]];
    [self.view addSubview:botomView];
    
    UIButton *cancelBtn = [[UIButton alloc] initWithFrame:CGRectMake(0, 1, 100, height - 1)];
    ...
    UIButton *confirmBtn = [[UIButton alloc] initWithFrame:CGRectMake(botomView.frame.size.width - 100.0f, 1, 100, height - 1)];
    ...
    [botomView addSubview:confirmBtn];
}
